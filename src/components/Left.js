    ...
    return(
        <div className="left">
            ...
            <div className="left-inner">
              <div className="info">
                <h2 className="name">Sai Koushik Gandikota</h2>
                <div className="subtext">DevSecOps FullStack Engineer</div>
                <div className="left-college">Exp. 6 Years @ Tata Consultancy Services </div>
